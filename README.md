...
Next, clone or download the repository and extract the fntsylu folder. Then go to your command line and change directory to said folder. Then type the following:
